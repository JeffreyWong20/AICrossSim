...
export MODEL_NAME="/home/thw20/projects/AICrossSim/ckpt/roberta/finetune/mnli/lr_1e-5"
# export MODEL_NAME="JeffreyWong/roberta-base-relu-mrpc"

# single task
export USE_SINGLE_TASK=true
export TASK_NAME="mnli"
export TASK_LIST="cola"
